...
const { getCPStats, getCPSubmissions, getLeetCode, getLeetCodeSubmissions, getPracticeReview, getSkillDecay, initCodeforcesVerification, checkCodeforcesVerification } = require('../controllers/cp.controller');
...
router.get('/skills/decay', protect, getSkillDecay);
